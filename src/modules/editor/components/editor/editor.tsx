...
//   onChange,
// }: {
//   onChange: (editorState: InitialEditorStateType) => void
// }) {
...
//                     <LexicalContentEditable placeholder="Write something..." />
//                   </div>
//                 </div>
//               }
...
//           <>
//             <PlainTextPlugin
//               contentEditable={<LexicalContentEditable placeholder="Write something..." />}
//               ErrorBoundary={LexicalErrorBoundary}
//             />
//             {/* <HistoryPlugin externalHistoryState={historyState} /> */}
//           </>
  ...
  return (
    <>
      ...
      >
        ...
        {shouldUseLexicalContextMenu && <ContextMenuPlugin />}
        {/* <ActionsPlugin isRichText={isRichText} shouldPreserveNewLinesInMarkdown={false} /> */}
      </div>
      {showTreeView && <TreeViewPlugin />}
    </>
  )
