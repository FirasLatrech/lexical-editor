...
function TableActionMenu({
  ...
  const toggleTableRowIsHeader = useCallback(() => {
    editor.update(() => {
      ...
      tableRow.getChildren().forEach((tableCell) => {
        ...
        ;(tableCell as any).setHeaderStyles(newStyle, TableCellHeaderStates.ROW)
      })
  ...
  const toggleTableColumnIsHeader = useCallback(() => {
    editor.update(() => {
      ...
      for (let r = 0; r < tableRows.length; r++) {
        ...
        tableCell.setHeaderStyles(newStyle)
      }
      clearTableSelection()
      onClose()
    })
  ...
  const toggleRowStriping = useCallback(() => {
    editor.update(() => {
      if (tableCellNode.isAttached()) {
        const tableNode = $getTableNodeFromLexicalNodeOrThrow(tableCellNode) as any
        if (tableNode) {
