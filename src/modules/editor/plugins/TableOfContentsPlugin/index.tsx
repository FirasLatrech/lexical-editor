...
function isHeadingAtTheTopOfThePage(element: any): boolean {
...
function isHeadingAboveViewport(element: any): boolean {
  const elementYPosition = element?.getClientRects()[0].y
  return elementYPosition < MARGIN_ABOVE_EDITOR
}
function isHeadingBelowTheTopOfThePage(element: any): boolean {
  const elementYPosition = element?.getClientRects()[0].y
  return elementYPosition >= MARGIN_ABOVE_EDITOR + HEADING_WIDTH
}

function TableOfContentsList({ tableOfContents }: { tableOfContents: Array<any> }): JSX.Element {
